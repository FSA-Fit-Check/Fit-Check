...
function App() {
  ...
  //C: Home and profile component are being passed props that are nullish values which are never going to change. Should probably get rid of them
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="/registration"
          element={<Registration setUserId={handleSetUserId} />}
        />
        <Route
          path="/profile"
          element={<Profile userId={userId} username={username} />}
        />

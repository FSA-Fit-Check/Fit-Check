...
const UserPrefForm = ({ userId }) => {
  ...
  return (
    <>
      <form onSubmit={(e) => handleSubmit(e)} className="panel">
      ...
      <br/> */}
        ...
        <label>
          ...
          <select
            ...
            value={formInput.garmentType}
            onChange={(e) =>
              setFormInput({ ...formInput, garmentType: e.target.value })
            }
          >
        ...
        <label>
          ...
          <select
            ...
            onChange={(e) =>
              setFormInput({
                ...formInput,
                weatherCompatibility: e.target.value,
              })
            }
          >
        ...
        <label>
          ...
          <select
            ...
            onChange={(e) =>
              setFormInput({ ...formInput, styleType: e.target.value })
            }
          >
            <option value="choose">Please Choose One</option>
        ...
        <label>
          ...
          <select
            ...
            onChange={(e) =>
              setFormInput({ ...formInput, occasion: e.target.value })
            }
          >
            <option value="choose">Please Choose One</option>
            <option value="business">Business</option>
        ...
        <label className="flex justify-center gap-3">
          ...
          <input
            ...
            onChange={(e) =>
              setFormInput({ ...formInput, forMen: e.target.checked })
            }
          />
        </label>
      ...
      flex flex-col gap-3"
        ...
        "
          >
            <img src="/form_icon.svg" className="icon"></img>
            ...
            {searchResults.map((result) => (
              <div key={result.id} className="split-container">
                ...
                <div className="garment-specification">
                  ...
                  <p>
                    <strong>Weather Compatibility:</strong>{" "}
                    {result.weather_compatability}
                  </p>
                  <p>
                    <strong>Style Type:</strong> {result.style_type}
                  </p>
                  <p>
                  ...
                  <p>
                    <strong>For Men:</strong> {result.forMen ? "Yes" : "No"}
                  </p>
                  <p>
